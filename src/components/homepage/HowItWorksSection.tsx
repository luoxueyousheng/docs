...
const steps = [
  {
    number: "I",
    title: "初始化库",
    description: "注册 app-ready 事件后初始化 DLL。极简参数，极速启动，完整流程仅需 16ms（不含 HTML 加载）。",
...
int main() {
  ...
  },
  {
    number: "II",
    title: "创建窗口",
    description: "配置窗口参数，一行调用即可创建 WebView 窗口。支持自定义标题栏、无边框窗口。",
...
uint32_t win = create_webview_window(
  ...
  },
  {
    number: "III",
    title: "IPC 通信与运行",
    description: "前后端双向 IPC，<1ms 延迟。jade.invoke 和 jade.on 即可实现高效通信。",
    code: `// 前端 JS：调用后端 API
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            三步开始。
            <br />
            <span className="text-background/50">无限可能。</span>
          </h2>
        </div>
          ...
          <div className="lg:sticky lg:top-32 self-start">
            <div className="border border-background/10 overflow-hidden">
              ...
              <div className="px-6 py-4 border-b border-background/10 flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-background/40">main.ts</span>
              </div>
