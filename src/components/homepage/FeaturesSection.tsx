...
const features = [
  {
    number: "01",
    title: "快速开始",
    description: "了解如何快速集成 JadeView 到你的项目中，几步即可完成窗口开发。支持多种语言 SDK。",
    visual: "deploy",
  },
  {
    number: "02",
    title: "事件系统",
    description: "完善的事件处理机制，支持窗口事件、导航事件和自定义事件，实现灵活的交互控制。",
    visual: "ai",
  },
  {
    number: "03",
    title: "IPC 双向通讯",
    description: "支持 IPC 双向通讯，前端 jade.invoke 调用后端方法并获取返回结果。",
    visual: "collab",
  },
  {
    number: "04",
    title: "资源安全",
    description: "JAPK 资源包格式，支持混淆、AES-256-GCM 加密与 Ed25519 签名，并支持内存载入，无需落地磁盘。",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            核心能力
            <br />
            <span className="text-muted-foreground">窗口、事件与样式一站集成</span>
          </h2>
        </div>
