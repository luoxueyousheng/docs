...
const integrations = [
  { name: "HTML5", category: "标记语言" },
  { name: "React", category: "前端框架" },
  { name: "Vue.js", category: "前端框架" },
  { name: "TypeScript", category: "编程语言" },
  { name: "Tailwind CSS", category: "CSS 框架" },
  { name: "Next.js", category: "全栈框架" },
  { name: "Three.js", category: "3D 图形" },
  { name: "Webpack", category: "构建工具" },
  { name: "Sass", category: "CSS 预处理器" },
  { name: "Bootstrap", category: "CSS 框架" },
  { name: "Angular", category: "前端框架" },
  { name: "Playwright", category: "测试工具" },
];
